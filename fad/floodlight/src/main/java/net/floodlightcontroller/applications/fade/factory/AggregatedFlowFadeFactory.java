...
public class AggregatedFlowFadeFactory extends CommonFadeFactory {
    ...
    public AggregatedFlowFadeFactory(int appId, String appName, double acceptedStatsDeviation, double detectionTagRatio, boolean ignoreTimeoutIssues,

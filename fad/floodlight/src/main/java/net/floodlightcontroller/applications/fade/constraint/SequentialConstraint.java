 ...
 */
abstract class SequentialConstraint extends AbstractConstraint {
     ...
     */
    protected void setSuspiciousFlows(List<Flow> suspiciousFlows){
    ...
    public String toString() {
        return "SequentialConstraint{" +
                ...
                ", passedSuspiciousFlow=" + passedSuspiciousFlow +
                '}';
    }
}

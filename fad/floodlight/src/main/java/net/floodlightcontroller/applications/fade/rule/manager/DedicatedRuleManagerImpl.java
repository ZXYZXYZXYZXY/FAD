...
public class DedicatedRuleManagerImpl implements DedicatedRuleManager {
    private static final Logger logger = LoggerFactory.getLogger(DedicatedRuleManager.class);

    ...
    public boolean doValidate(StatsContext statsContext) {
        ...
        exp.addFunction(exp.new Function(RETRIEVE_STATS_FUNC_NAME, 1) {
            ...
            public BigDecimal eval(List<BigDecimal> parameters) {
                ...
                logger.info("retrieve flow rule with index {} with packet count {}", cookie, pktCount);
        ...
        logger.info("get flow statistics of flow {}: values are: {} (possibly incomplete)", this.flow, stats);
